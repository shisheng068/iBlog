...
public class MsgServiceImplByAliyun implements MsgService{
	...
	private static final String accessKeyId = "LTAIhN4ReQSZXiDO";//你的accessKeyId,参考本文档步骤2
	private static final String accessKeySecret = "rFjdRTGr0j6u54k3G9388QACNlFSdD";//你的accessKeySecret，参考本文档步骤2
	private static final String signName = "iBlog博客";//你的accessKeySecret，参考本文档步骤2
	...
	@Override
	public ReturnDto sendCaptchaMsg(String phoneNum, String captchaCode)
		...
		request.setOutId("senMsgCaptcha");
